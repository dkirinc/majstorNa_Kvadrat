...
const Gallery = ({ ref, admin }) => {
    ...
    const { galleryData, galleryRefresh } = useAppContext()
    ...
    return (
        <div id='gallery' className='xl:w-[1200px] py-32 self-center flex flex-col items-center gap-16'>
            ...
            <div ref={ref} className=' w-[310px] md:w-[620px] lg:w-[900px] xl:w-[1200px]  flex items-center overflow-hidden lg:overflow-visible'>
